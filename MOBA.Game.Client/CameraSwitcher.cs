...
public sealed class CameraSwitcher : IEngineSystem
{
    ...
    public CameraSwitcher(IInputContext input, float aspectRatio)
    {
        FreeFly = new FreeFlyCameraController(input, aspectRatio);
        TopDown = new TopDownCameraController(aspectRatio);
        ActiveCamera = FreeFly.Camera;
